...
## Project Structure
    ...
    ├── testapiautosetting_126626  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126626`
...
2. Clone this repo and `cd testapiautosetting_126626`
